...
<BODY bgcolor=ivory style="margin: 0px" style="overflow-x:hidden"
...
BUTTON {
	...
	out.println(db.fetchRecords("matrimony.matrimony_customer_info",fields,"profile_id='"+session.getAttribute("Client")+"'",500,1,false));
%>