...
<%t.checkSession();%>
<html><HEAD>
<fieldset><legend>Delete Profile</legend>
<center><span style='font:bold 12px tahoma;color:maroon'>Profile Id&nbsp;&nbsp;:&nbsp;&nbsp;<%=session.getAttribute("Client")%></center></span><BR>
<form action='<%=t.getPath("/Pages/DeleteProfile.jsp")%>' method=post>
<Center><h4>Are You Sure To Delete Your Profile Permanently ?</h4></center>
<%
	t.getError();
