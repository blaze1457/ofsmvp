...
<TR>
	<TR><TD align=right class=cell>Profile Id&nbsp;&nbsp;:&nbsp;&nbsp;<TD><input type=text class=input name="profileid" onkeypress="return blockKey(event,6)">&nbsp;&nbsp;</TD></TR>
	<TR><TD align=right class=cell>Mail Id:&nbsp;&nbsp;:&nbsp;&nbsp;<TD><input type=text class=input name="emailid" onkeypress="return emailID(event,30)">&nbsp;&nbsp;</TD></TR>
	<TR><TD align=right class=cell>Get Password &gt;&gt;<TD><button type=submit class=button accesskey='F'><u>F</u>ind</button></TD></tr>
