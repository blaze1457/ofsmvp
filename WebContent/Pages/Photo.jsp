...
%>
<title>Process File Upload</title></head>
<STYLE>
H4		{
			background				:	#424334;
			color					:	aliceblue;
...
%>
<BR><center><button class=button onclick='parent.location="PhotoUpload.jsp"' accesskey='U'><u>U</U>pload Photo</button>&nbsp;&nbsp;&nbsp;&nbsp;</center><BR>